...
(async function () {
  ...
  const GROUPS = [
    ...
    ['Bomba', { bombCount: 'Bombas por vida/round', bombRange: 'Alcance do lançamento', bombFlight: 'Tempo voando (s)', bombFuse: 'Tempo até explodir no chão (s)', bombRadius: 'Raio da explosão' }], ['Cidade à noite', { lampLight: 'Luz do poste (raio)', lampOff: 'Poste apagado (s)', nightSee: 'Você enxerga em volta', nightDark: 'Escuridão (0-1)' }], ['Vulcão', { lavaInterval: 'Lava a cada (s)', lavaWarn: 'Aviso antes (s)', lavaDuration: 'Tempo com lava (s)', lavaPairs: 'Pares de poças', lavaRadius: 'Tamanho da poça' }], ['Nave espacial', { meteorInterval: 'Meteoros a cada (s)', meteorWarn: 'Aviso antes (s)', holeRadius: 'Tamanho do buraco', meteorMax: 'Quedas de meteoro por round', holeSlow: 'Beira: velocidade para dentro (0-1)' }], ['Fumaça', { smokeCount: 'Fumaças por vida/round', smokeRadius: 'Raio da fumaça', smokeTime: 'Duração (s)', smokeCore: 'Miolo fechado (0-1)' }],
    ['Mata-mata', { respawnDelay: 'Tempo para renascer (s)', spawnProtect: 'Proteção ao renascer (s)' }],
    ['Rei da colina', { hillRadius: 'Tamanho da colina', hillPointsPerSec: 'Pontos por segundo', hillMoveEvery: 'Tempo de cada área (s)', hillPreview: 'Prévia da próxima (s)' }],
    ['Portais', { portalFirstOpen: 'Abertos no começo, esq./dir. (s)', portalFirstClosed: 'Depois fechados (s)', portalOpen: 'Tempo aberto (s)', portalClosed: 'Tempo fechado (s)' }],
