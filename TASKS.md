...
Última atualização: 26/09/2026 — v0.23.0 (Three.js): obra em octógono e fábrica em hexágono (paredes em diagonal), minimapa com inimigo aparecendo quando atira e raio do som, contador de vivos, sons só os seus/por distância, granada segurando pra jogar longe, pulo duplo com botas douradas, editor com ícones e cor da pele, portais e cidade bem mais leves, estilo Cargo no mar. Antes, v0.22.0 (Three.js): 2 mapas novos com formato irregular (Canteiro de obras com bola de demolição girando e Fábrica com pistões e esteiras), killcam que começa na câmera de quem atirou e segue o tiro em câmera lenta, pirâmide gigante no meio do deserto, casa na árvore alta com escadas de mão, iglus gigantes no meio, trem de ida e volta, onda vindo do horizonte, cidade com prédios em volta, vulcão com cratera enorme, bots com a sua arma no modo sozinho. Antes, v0.21.0 (Three.js): 2 mapas novos (Estação de metrô com trem passando e Plataforma no mar com onda gigante, navio e torcida), varinha mágica, casa na árvore na floresta, pirâmides no deserto, vulcão com céu e paisagem de verdade, nave com portas que fecham áreas, mira reta, granada com arco de alcance, killcam com o boneco caindo, eventos a cada 20 s. Antes, v0.20.0 (Three.js): mapas 40% maiores e redesenhados (caverna na floresta, iglus na neve, portas automáticas e meteoros na nave, andar de cima com pontes nos portais, ruas e postes na cidade, dunas variadas e pirâmides no deserto), portais abrindo e fechando sozinhos, tempestade congelante, lava furando o chão, mira com zoom e força no botão direito, besta na 1ª pessoa, munição por arma, killcam final com efeito de lente, animação da poção, 5 personagens e roupas personalizáveis por time. Antes, v0.19.0 (Three.js): modos do 2D (rounds, mata-mata em equipe, cada um por si, rei da colina), killcam, correr no Shift, só arco/estilingue/bolinha, eventos de mapa com a regra dos 25 s, vulcão flutuante, mapas fechados até o teto, opções de som, ping no Tab, bots no seu time. Antes, v0.18.0 (Three.js): mapas refeitos a pedido do Caique (portais ovais de ver através, base na Lua, postes que iluminam, deserto com montanhas de areia, árvores grandes, vulcão com buracos de lava, gelo de verdade) + modo teste só pra você + sala reconecta sozinha. Antes, v0.17.0 (Three.js): **tempo limite de round** no multiplayer (dono escolhe: sem limite/2/3/5/10 min; acaba a partida quando zera, ganha quem tem mais abates, empate se empatar) e **sons** sintetizados (tiro, faca, acerto, abate, pulo, aterrissagem, ricochete, recarga, explosão, arremesso, pickup — com volume/direção por distância e botão de mudo em Controles). Godot pausado por ora. https://point-ball.onrender.com
...
- [x] v0.23.0 (Three.js): sexta rodada de ajustes do Caique (só no 3D)
  - [x] **Formato irregular de verdade**: Canteiro de obras virou **octógono** e a Fábrica virou **hexágono** (paredes em diagonal com colisão, tiro ricocheteando nelas, minimapa com o formato)
  - [x] **Minimapa** (em cima à esquerda): seu time sempre; inimigo só aparece um instante onde atirou (igual COD); círculo tracejado = até onde você ouve um tiro. Embaixo dele: **quantos estão vivos** de cada time
  - [x] **Sons**: acerto e abate só os seus; tiros, aterrissagem, facada, ricochete e explosão dos outros com volume pela distância; pulo, arremesso de granada e recarga dos outros não fazem som; trem com buzina de metrô e barulho de trilho; torcida do navio gritando
  - [x] **Nome em cima da cabeça** só aparece com 70% do corpo à vista (atrás do muro não entrega)
  - [x] **Granada**: segura pra jogar mais longe; pulando vai um pouco mais forte; quica menos e rola pouco; só 1 linha (até o primeiro toque) e área mais transparentes; animação de puxar o braço e arremessar; explosão maior (150) com fogo correndo até a borda da área; fumaça um pouco mais leve
  - [x] **Besta** na força máxima de antes; **estilingue e mão** mais fortes e menores na tela; **arma certa na mão** em 3ª pessoa (estilingue, bolinha de neve, varinha); **faca** da 1ª pessoa igual à da 3ª; raio da **varinha** mais curto e fininho, forte na frente e sumindo atrás
  - [x] **Pulo duplo carregado**: botas douradas brilhando e pegadas douradas curtinhas (só você vê as suas)
  - [x] Círculo da mira só aparece carregando; **editor do personagem** com ícones, cor da pele e girando com o mouse
  - [x] Desempenho: **portais** (desenho do outro lado mais leve, no máximo 2 por quadro, sem luz em cada portal, shaders preparados ao carregar), **cidade** (só as 6 luzes mais perto de verdade, metade das janelas acesas, materiais compartilhados), luzes de explosão/erupção fixas (não trava mais)
  - [x] Cidade: alguns postes piscam sozinhos (3 a cada 5 s); casas com poucas janelas
  - [x] Vulcão: boca do vulcão um pouco menor. Floresta: buraco aberto onde a escada sobe, caminho reto do nascimento até a escada, furacão mais transparente e só 2 voltas. Deserto: mapa maior, dunas mais pros cantos, base da pirâmide livre. Neve: nevasca 30% mais larga, bem transparente e 1 s a mais. Sala escura: 2,5 s apagada
  - [x] Nave: bonecos com brilho na cor do time (dá pra ver melhor); vidraças dos cantos com colisão; meteoros somem no round novo
  - [x] Metrô: escada mais larga com parapeito, câmera sem pular nos degraus, paredes equilibradas. Mar: estilo Cargo (subida de caixote em contêiner virada pro inimigo), paredes maiores, torcida leve com 420 torcedores, próxima onda já aparece lá longe vindo, sem água cobrindo o chão. Obra: cidade em volta, bola dá 2 voltas começando de onde parou. Fábrica: pistões sobem até a passarela e as pilhas de estoque (230), esteira anda pro lado certo
  - [ ] Validar no PC (FPS) e jogar o multiplayer com 2+ pessoas

- [x] v0.22.0 (Three.js): quinta rodada de ajustes do Caique (só no 3D)
  - [x] **Killcam segue o tiro**: começa na câmera que quem matou estava usando (1ª ou 3ª pessoa; bot = 3ª), mostra o disparo e depois a câmera sai atrás do tiro que matou, em câmera lenta, até acertar; o abatido fica cinza e cai
  - [x] **Besta sem força** ao segurar o botão (só o tempo pro próximo tiro); estilingue e bolinha também sem força
  - [x] **Modo sozinho: os bots usam a mesma arma que você** (no multiplayer cada um escolhe a sua)
  - [x] **Animação de recarga em cada arma** (1ª pessoa): besta engatilha e a flecha nova desliza, estilingue pega pedra e estica o elástico, mão aperta bolinha nova, varinha gira e a ponta recarrega o brilho
  - [x] **Raio da varinha 4x maior**, em zigue-zague tremendo (parece um raio) com galhinhos
  - [x] **Círculo da mira**: branco meio transparente esperando o próximo tiro; amarelo recarregando o pente
  - [x] **1ª pessoa**: a altura da câmera segue o seu tamanho (menor quando leva tiro); crescer/diminuir com animação (poção não "pisca" mais)
  - [x] **Menu Esc com tamanho fixo** (trocar de aba não mexe o painel)
  - [x] Deserto: **1 pirâmide enorme no meio** (390 de altura, topo reto, sem cacto nem pedra em cima); dunas com 4 tamanhos, algumas **montanhas bem altas**
  - [x] Floresta: furacão **maior (265), dura mais (6,5 s) e anda mais rápido**; **casa na árvore 2x mais alta** (380) com **escadas de mão no tronco** (uma virada pra base de cada time) que sobem por um alçapão e saem no meio da casinha; **copas das árvores bem mais altas** (teto de folhas em 700)
  - [x] Neve: **2 iglus com o dobro do tamanho no meio do mapa** (em cima e embaixo), portas viradas pra cada base
  - [x] Metrô: **só 2 trilhos**; o trem é **bem mais comprido e alto** (tampa a visão) e vai por um trilho e **volta pelo outro** (começo sorteado); **mezanino alto com escadas de degraus** em cada base (nascimento sempre embaixo); **mais paredes** (grades, máquinas, caixas, ilha no meio)
  - [x] Mar: **32 torcedores** no navio; a **onda aparece lá no horizonte e vem crescendo** até o mapa; visual novo da onda (água escura embaixo, verde-água na crista, espuma e spray); borda de **vidro** (dá pra ver o mar); **pilhas de contêineres e caixotes** coloridos pra subir (estilo porto de carga); **menos gaivotas** e com cara de gaivota
  - [x] Cidade: **1 poste por pedaço do mapa** cobrindo tudo (base também); **prédios e casas à noite** em volta, com algumas janelas acesas
  - [x] Nave: **meteoro novo** (pedra inteira, sem buracos); indicador da porta virou uma **barrinha na parede do lado**, que desce e muda de cor (verde → amarelo → vermelho) quando a porta vai fechar
  - [x] Vulcão: **buracos 30% maiores**; **boca do vulcão enorme** (cratera com paredes por dentro, brilho da lava e lago no fundo) e borda baixa pra ver lá embaixo; **rios de lava** novos (fitas largas coladas na encosta, com crosta e brilho)
  - [x] Sala escura: a luz fica **apagada mais tempo** (4,5 s)
  - [x] **Mapa novo: Canteiro de obras** (formato de octógono com recortes) — guindaste no meio; a cada 20 s acende um círculo vermelho no chão e a **bola de demolição dá uma volta inteira** arremessando quem estiver no caminho; prédios em construção em volta
  - [x] **Mapa novo: Fábrica** (formato de cruz, fechada) — sem evento, mas **pistões gigantes sobem e descem** o tempo todo (viram cobertura e lugar alto, carregam quem está em cima) e **2 esteiras** levam quem pisa nelas
  - [ ] Validar no PC (FPS dos mapas novos) e jogar o multiplayer com 2+ pessoas

- [x] v0.21.0 (Three.js): quarta rodada de ajustes do Caique (só no 3D)
  - [x] **Mira reta**: o tiro sai reto pra onde a mira aponta, sem compensar a queda (o jogador calcula); botão direito só dá zoom e anda um pouco mais devagar (sem barra de força); **sem círculo** embaixo dos bonecos
  - [x] **Eventos de mapa a cada 20 s** (antes 25)
  - [x] **Granada**: sai da mão pra frente e mais forte, mostra o **arco e a área** onde vai explodir; explosão bem mais visível (bola de fogo, onda de choque no chão, fumaça, faíscas) e **área maior** (135)
  - [x] Poção **verde** (não parece mais que tomou hit); **faca** da 1ª pessoa igual à da 3ª
  - [x] **Killcam**: sem o círculo branco, borda escura suave, sem lápide; o boneco abatido **fica cinza e cai** pro lado contrário do tiro; espera ~1,6 s depois do abate antes de começar
  - [x] Portais: **cantos largos** no andar de cima e **teto mais alto** (660); a câmera da 3ª pessoa não passa do teto
  - [x] Sala escura: **todas as paredes até o teto**. Cidade: onde 3 pontas se encontram, **1 poste só** (6 postes)
  - [x] Neve: a neve/pinheiros de fora **não entram mais** no mapa; **2 iglus grandes** (um de cada lado) sem buraco do lado da porta
  - [x] Floresta: **casa na árvore** no meio (tronco, chão redondo sem parapeito, 2 escadas — sobe andando); o furacão passa por ela e joga quem estiver em cima; quem é pego **gira 2 voltas subindo até o topo** e é lançado; vento **bem mais transparente**
  - [x] Nave: **meteoro bem maior**; layout novo — a baia de nascimento de cada time e a sala do meio são **fechadas**, só se passa pelas portas
  - [x] Vulcão: **buracos irregulares**; paredes de **pedra vulcânica escura** e todas da mesma altura; **céu de verdade** e lá embaixo cratera de pedra, rios de lava, terra, morros e o mar (não parece mais o inferno)
  - [x] Deserto: dunas **mais largas e suaves** (dá pra subir andando, com tipos diferentes); **2 pirâmides** perto de cada nascimento com topo reto; cactos maiores
  - [x] **Varinha mágica**: raio rápido e reto (traçante comprido e brilhante) que ricocheteia 3 vezes, som próprio
  - [x] **Mapa novo: Estação de metrô** — pilares, 3 linhas de trem, túneis; a cada 20 s acende a luz vermelha num trilho, toca a buzina e o trem passa arremessando quem estiver na linha
  - [x] **Mapa novo: Plataforma no mar** — convés de madeira no meio do oceano, contêineres; a cada 20 s uma **onda gigante** vem de um lado (nunca do lado do navio), passa por cima da borda e **arrasta** quem pegar, e a água escorre pelos ralos; **navio alto com torcida** dos dois times comemorando, **boias** e **gaivotas** voando e pousadas
  - [ ] Validar no PC (FPS dos mapas novos) e jogar o multiplayer com 2+ pessoas

- [x] v0.20.0 (Three.js): terceira rodada de ajustes do Caique (só no 3D; o 2D não mudou)
  - [x] **Todos os mapas 40% maiores** (2240 x 1400), montados em `public/demo3d/world3d.js` (servidor e navegador usam o mesmo)
  - [x] Floresta: plantinhas do chão bem menores; **caverna escura no meio com 4 saídas** (o furacão não entra nem pega quem está dentro); **mata fechada em volta** (muitas árvores leves)
  - [x] Furacão **maior** (pega num raio de 210) e com visual de **vento** (faixas finas girando, poeira e folhas no chão), sem as "bolas"
  - [x] Deserto: areia de fora **não invade mais** o mapa; tempestade de areia **sem deixar lento**, visual antigo (neblina de areia no mapa todo); dunas **mais largas e de alturas diferentes** (baixas, médias e montanhas altas); mais dunas em volta e **pirâmides**
  - [x] Neve: **tempestade congelante** — faixa de vento gelado que corta o mapa de ponta a ponta em lugar sorteado (nunca na área de nascimento), com aviso no chão; deixa devagar e empurra; paredes de gelo **menos transparentes**; **4 iglus redondos** (opacos, 2 entradas cada); pinheiros com neve, gelo e montanhas em volta
  - [x] Nave: **meteoros** (regra do 2D: 25 s, sombra de aviso) caem do céu, **furam o vidro do teto** e ficam dentro de vez tampando visão/passagem (1 de cada lado, espelhado, 2 vezes); **portas automáticas** que abrem pros lados quando alguém chega perto e fecham depois (paredes continuam baixas)
  - [x] Vulcão: a lava **estoura o chão de baixo pra cima** (coroa de lava, gotas e pedaços voando) e cai de volta deixando o buraco (um pouco maior); nuvens escuras de cinza em volta (ainda dá pra ver o vulcão lá embaixo); paredes do meio mais altas
  - [x] Portais: teto mais alto (520) e **andar de cima**: passarela em volta (mais estreita nos cantos) e 2 pontes finas cruzando o mapa, uma **quebrada com buraco pra pular**; sem parapeito. Só dá pra subir por portal
  - [x] Portais **aleatórios com a regra do evento**: começa aberto (2,5 s), fecha 6, abre 5, depois fecha 6 / abre 6 até o fim; nunca 2 na mesma parede no mesmo andar, nunca um par todo em cima; **portal fechado vira parede lisa** (ninguém sabe onde vai abrir)
  - [x] Sala escura um pouco mais escura com a luz acesa; umas paredes mais altas (as do meio vão até o teto)
  - [x] Cidade: chão de **rua** (asfalto, calçadas em volta dos muros, faixas pintadas); **8 postes** grudados nas pontas dos muros
  - [x] **Bug da mira** corrigido: a compensação da queda do tiro jogava a bala acima da mira quando mirava pra cima; agora usa a conta de balística de verdade (e a altura do olho igual à da câmera)
  - [x] **Botão direito = mirar**: zoom (dá pra desligar nas configurações), anda mais devagar, e uma **barra de força** que carrega enquanto segura (tiro mais rápido e reto, dano igual); a arma quase não se mexe
  - [x] **Munição por arma** (cor do time): flecha, pedrinha meio quadrada (estilingue), bola de neve (mão)
  - [x] **Besta (crossbow)** na 1ª pessoa, igual à que o boneco segura em 3ª pessoa
  - [x] **Killcam final**: só a última kill do round/partida, pros dois times, com **câmera lenta e efeito de lente** (zoom, distorção, cor separando, vinheta, granulado) perto do tiro acertar
  - [x] **Animação da poção** em 1ª pessoa (garrafa à boca, líquido acabando, brilho de cura) e em 3ª (garrafa na mão)
  - [x] **Personagens e roupas**: 5 personagens (Ladino com capuz, Ladino, Cavaleiro, Bárbaro, Maga — KayKit CC0), cores por **tons do time** (estilo Rocket League) em camisa, calça, capa/capuz, chapéu/elmo, armadura, botas, luvas, cabelo; capa liga/desliga, macacão, **chapéu extra** (boné, gorro, cartola, caubói, coroa, faixa); aba "Personagem" com prévia dos 2 times; bots sorteiam roupa; no multiplayer todo mundo vê
  - [ ] Validar no PC (FPS com os mapas maiores e 5 modelos) e jogar o multiplayer com 2+ pessoas
